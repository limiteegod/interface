...
Handle<Value> stringTest(const Arguments& args)
{
    ...
    vs::VsObjectArray<vs::String> *oa = str->split(',');
    delete oa;
 ...
 * 对象数组测试
 */
Handle<Value> objectArrayTest(const Arguments& args)
{
    HandleScope scope;
    ...
    vs::VsObjectArray<vs::String> *oa = new vs::VsObjectArray<vs::String>(2);
    vs::String* str1 = new vs::String(20, ",welcome!");
    vs::String* str2 = new vs::String(20, "ok!");
    oa->put(str1);
    oa->put(str2);
    ...
    vs::String* str3 = new vs::String(20, "ok!222");
    oa->put(str3);
    printf("数组长度:%d\n", oa->getLength());
    printf("数组容量:%d\n", oa->getVolume());
 ...
 * 单链表
 */
Handle<Value> sListTest(const Arguments& args)
{
    HandleScope scope;
    ...
    SingleLinkedNode* nodeToDelete = list->deleteById(5);
    delete nodeToDelete;

    list->traverse();

    SingleLinkedNode* tNode = list->findById(2);
    printf("找到的节点id:%d\n", tNode->id);
...
void init(Handle<Object> exports) {
    ...
    exports->Set(String::NewSymbol("objectArrayTest"), FunctionTemplate::New(objectArrayTest)->GetFunction());
    exports->Set(String::NewSymbol("sListTest"), FunctionTemplate::New(sListTest)->GetFunction());
}
